...
public class UI {
	...
	public static void printMatch(Chess_Match chessMatch, List<Chess_Piece> captured) {
	...
	private static void printCapturedPieces(List<Chess_Piece> captured) {
		List<Chess_Piece> white = captured.stream().filter(x -> x.getColor() == Color.WHITE).collect(Collectors.toList());
		List<Chess_Piece> black = captured.stream().filter(x -> x.getColor() == Color.BLACK).collect(Collectors.toList());
